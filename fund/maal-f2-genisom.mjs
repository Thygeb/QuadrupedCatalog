/* Maaleredskab for spor/f2-genisom. Koeres FOER og EFTER arbejdet.
   Kopi af fund/maal-f2.mjs, rettet: process.exit(1) efter fetch (linje 11 i
   originalen) er skiftet til process.exitCode + throw, jf. exit-127-faelden.
   Brug:  node fund/maal-f2-genisom.mjs <robot_id[,robot_id...]> */
