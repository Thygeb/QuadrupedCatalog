...
| **Å15** | **Revisionshistorik hører i arkivet, ikke i datafilerne.** Fastslået 25. aug 2026 under KRITIK-2 fund 1. To destinationer blev afprøvet og forkastet med måling: **YAML-kommentarer** overlever ikke databasen ( i  udsender aldrig  — den kender kun tegnet, når den læser, så kommentarer slettes tavst, første gang en post regenereres fra Studio), og **** duer heller ikke, fordi feltet vises på robotsiden. Reglen er derfor:  bærer kun producentvendte forbehold; hvorfor-vi-rettede-det hører i  eller , og en note må aldrig slettes fra en datafil, før det er efterprøvet, at arkivet bærer den. Bør skrives ind i robotdata-skillen, når spor/prosa er flettet |
