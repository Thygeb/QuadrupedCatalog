...
| **Å16** | **To worktrees står på pause og skal enten genoptages eller slettes.** `spor/retning-atlas` i `C:/Praktik/websites/udstilling-wt-ret2` og `spor/retning-moerk` i `C:/Praktik/websites/udstilling-wt-ret3`, begge på commit `d9a64d4`. Det er de to designretninger, JPK satte på hold 25. aug 2026, da LYS blev valgt ("vi nøjes med det ene design"). Der ligger kun minimalt arbejde i dem. De stod nævnt nul steder, indtil de blev fundet ved en optælling — hvilket er præcis grunden til, at en pauset worktree nu skal skrives her |
