...
| **L15** | **Informationsarkitektur** | **Forsiden organiseres efter vægtklasse** (under 20 kg · 20-60 kg · over 60 kg), ikke efter producent. Producentsider findes som andet niveau og bærer EU-kolonnen. Hver robot beholder sin egen URL. Begrundelse: 43 robotter ligner hinanden; størrelse er den eneste forskel, en køber både kan se og bruge — og tre producenter har 26 af de 43, så producentopdeling giver en skæv forside. **Grænserne er afløst af L27:** 20/40 kg, ikke 20/60 kg, og med en fjerde gruppe til de robotter, der ikke oplyser en vægt |
| **L22** | **Å10 — syvende anvendelseskategori** | **`sikkerhed_overvaagning` er tilføjet.** Sat på seks robotter med producentens eget ord, hentet ordret i den gemte råfil: Unitree As2-W (*"ideal for security, inspection…"*), DEEP Lynx S10 (*"security patrol"*), DEEP X30 og X30 Pro (*"…investigation, security, surveying and mapping"*), Rainbow RBQ-10 (*"…scenarios such as surveillance, inspection, and observation"*), Raion RAIBO2 (*"…for patrol, inspection, and research workflows"*). R16 gælder uændret: kategorien koster et ordret citat |
| **L23** | **Å11 — arv til varianter** | **Tilladt, men kun synligt mærket.** Posten skal bære `arvet_fra: <slug>` og vise moderens citat. Håndhæves af **R17**, som er strengere end R16: moderen skal findes, selv have et citat, ikke selv have arvet, og variantens kategorier og citater skal være delmængder af moderens, med moderens kilde. Arvet: Unitree B2-W ← B2, Go2-W ← Go2, DEEP X30 Pro ← X30. **Ikke** arvet: LYNX M20-Pro og M20S, fordi producenten selv skriver om *"The LYNX M20 series"* — dér er der ingen slutning at mærke. Åbent hul: se **D10** |
| **L27** | **Anvendelse er flerværdi, og vægtklasse er afledt** | **Reglen om hovedpositionering er fjernet.** Kategorierne er en usorteret mængde; generatoren lægger dem i en fast kanonisk orden, så rækkefølgen ikke kan læses som mening. Begrundelse: `KRITIK-1-plan.md` K4 målte, at reglen lod en producents navigationsmenu afgøre, hvor ti robotter havnede. **Vægtklasse** (`under_20` · `20_40` · `over_40` · `ikke_oplyst`) beregnes i `tools/build.mjs` af `egenvaegt` og står aldrig i data. Målt over 46 poster: **12 / 12 / 13 / 9** |
